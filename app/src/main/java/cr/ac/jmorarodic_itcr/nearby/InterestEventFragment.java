...
public class InterestEventFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        for(int i =0; i<10;i++) {
            EventCalendarItem e = new EventCalendarItem(R.drawable.learn, "Titulo de noticia", "14 Abril 2018");
            eventos.add(e);
        }

        //Carga en listview
        final ListView listView = (ListView) RootView.findViewById(R.id.interestEventList);
