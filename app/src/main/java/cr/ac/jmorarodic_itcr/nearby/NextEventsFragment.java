...
public class NextEventsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View RootView = inflater.inflate(R.layout.fragment_next_events, container, false);

        ArrayList<EventCalendarItem> eventos = new ArrayList<>();

        for(int i =0; i<10;i++) {
            EventCalendarItem e = new EventCalendarItem(R.drawable.nature, "Titulo de noticia", "14 Abril 2018");
            eventos.add(e);
        }

        //Carga en listview
        final ListView listView = (ListView) RootView.findViewById(R.id.nextEventList);
